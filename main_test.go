...
import (
	...
	"github.com/kyong0612/sqlc-playground/repository"
	"github.com/ory/dockertest/v3"
	"github.com/ory/dockertest/v3/docker"
)

var q *persistence.Queries
var conn *pgx.Conn
...
func TestUpdateUserAgesWithTransaction(t *testing.T) {
	// ユーザーを作成
	u, err := q.CreateUser(context.Background(), persistence.CreateUserParams{
		Name:  "test",
		Email: "test@test.com",
		Age:   20,
	})
	...
	// 年齢を+1する関数を実行
	err = repository.IncrementUserAges(context.Background(), conn, q, u.ID)
	if err != nil {
		t.Fatal(err)
	}
